...
- [Rezepturencheck](#rezepturencheck)
  ...
  - [Erstattungscheck](#erstattungscheck)
  - [Rezeptpflichtstatus](#rezeptpflichtstatus)
  - [Kompatibilität der Substanzen mit Salbengrundlage](#kompatibilität-der-substanzen-mit-salbengrundlage)
  - [Dosierung von lokal applizierten Wirkstoffe](#dosierung-von-lokal-applizierten-wirkstoffe)
  - [Bedenkliche Bestandteile](#bedenkliche-bestandteile) 
- [Hartfettmengenrechner](#hartfettmengenrechner)
  - [Ohne Upload](#ohne-upload)
...
Um eigene Rezepturen abzuspeichern, erstellen Sie einen [eigenen Datensatz](#eigenen-datensatz-für-upload-erstellen) oder laden sie auf der Startseite unter **interne Sammlung** Ihren Datensatz hoch. 
...
Unter **neue Rezeptur** kann die Zusammensetzung einer Rezeptur eingetragen werden. Man kann Substanzen aus der Arzneitaxe auswählen oder andere Substanzen eintragen. Mengenangaben können entweder in g oder ml angegeben werden. Wenn mit einer Substanz bis zu einer bestimmeten Menge aufgefüllt werden soll, drücke **ad** und gib dahinter die Gesamtmenge an. 
...
>Wird beim Hartfettmengenrechner eine Substanz nicht gefunden, wählen Sie **Substanz nicht in Liste vorhanden**. Dadurch erscheint ein neues Fenster. Mit diesen Fenster können Sie neue Substanzen und deren Verdrängungsfaktoren zu Ihren Datensatz hinzufügen. Klicken Sie dabei auf **übernehmen**. <br>
>
...
>Um Rezepturen in der Rezepturensammlung zu suchen, wählen Sie die Bestandteile der Rezeptur unter **Zusammensetzung der Rezeptur** aus. Auf der rechten Seite finden Sie die gefundenen Rezepturen.
>
><img src="screenshot/10.png" alt="drawing" width="50%"/>

Um zusätzliche Informationen sehen zu können, klicken Sie die gewünschte Rezeptur an. <br>
...
Ergebnisse der Rezepturkontrollen erscheinen auf der linken Seite. Durch klicken darauf gelangt man zur entsprechenden Seite
...
| **Dosierung von lokal applizierten Wirkstoffe** | |
| <img src="screenshot/22.png" width="200"/> |  über mindestens ein Bestandteil sind Dosierungsinformationen vorhanden |
| **Bedenkliche Bestandteile** | |
| <img src="screenshot/23.png" width="200"/> |  ausgewählte Substanz ist als bedenklich eingestuft |
| <img src="screenshot/24.png" width="200"/> | ausgewählte Rezeptur enthält mindestens eine bedenkliche Substanz |
...
>Bei Bestandteile die sich nicht in der grünen Box befinden erscheint eine rote Meldung. <br>
...
Die Konzentration der Arzneistoffe wird automatisch berechnet. Dabei muss die insgesamt herzustellende Menge und die Arzneistoffmenge angegeben werden. 

>Befindet sich diese Konzentration außerhalb der therapeutisch üblichen Konzentration erscheint eine rote Meldung.
>
